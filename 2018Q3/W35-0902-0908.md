...
> Generated on 2018-09-10 09:29

## Summary

* Pushed **89** commits to master branch
* Created **47** pull requests, merged **33**
* Resolved and closed **37** issues
* Crafted and deployed **20** internal releases
...
| ArcBlock/arc-wallet-android  | 7       | 2 (2 merged, 0 active)  | closed 2 | published 2 , latest v0.0.3  |
| ArcBlock/dapp-token-flow     | 5       | 2 (1 merged, 1 active)  | closed 1 | published 1 , latest v0.1.1  |
...
| ArcBlock/arc-wallet-ios      | 6       | 1 (1 merged, 0 active)  | closed 1 | -                            |
...
- [arc-wallet-android] add card view for wallet tab(#2) 09-07
- [arc-wallet-android] setup travis(#1) 09-04
- [dapp-token-flow] project skeleton(#1) 09-04
...
- [arc-wallet-ios] Wallet tab list view(#8) 09-03
